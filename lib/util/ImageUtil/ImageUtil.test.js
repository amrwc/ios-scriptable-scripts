...
describe('ImageUtil', () => {
	...
	it.each([...IMAGE_TYPES, 'unsupported'])('should have got an empty string when base64 encoding fails', (type) => {
		const image = jest.fn();
	...
	it.each([...IMAGE_TYPES])('should have got a base64-encoded image', (type) => {
		const image = jest.fn();
