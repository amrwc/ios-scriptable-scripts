...
describe('ImageUtil', () => {
	...
	it.each([JPG, PNG, 'unsupported'])('should have got an empty string when base64 encoding fails', (type) => {
	...
	it.each([JPG, PNG])('should have got a base64 encoded image', (type) => {
		const image = jest.fn();
